...
| Pset 8 | DFS, topological sort, strongly connected components | Edge classification (tree/back/forward/cross edges), Tarjan/Kosaraju | Edge classification is what makes cycle detection and topological sort fall out of DFS almost for free. |
