...
| Pset | Topic | Key techniques | Notes |
|---|---|---|---|
| Pset 4 | Discrete random variables | PMFs, expectation, variance | Builds directly on 6.042's counting unit; expectation here is where "average value" gets a formal definition via the PMF. |
