...
Personal problem set notes for each of the six MIT OCW courses in this portfolio. Each file tracks what each pset covers, the key techniques, and my own notes on what was conceptually hardest and where the ideas connect to the code.
...
Each course file is structured as a table with four columns:
...
## The six course notes

### [6.042J: Mathematics for Computer Science](./6.042-Mathematics-for-Computer-Science_pset_notes.md)
...
### [6.041: Probabilistic Systems Analysis](./6.041-Probabilistic-Systems-Analysis_pset_notes.md)
...
### [6.036: Introduction to Machine Learning](./6.036-Introduction-to-Machine-Learning_pset_notes.md)
...
### [6.034: Artificial Intelligence](./6.034-Artificial-Intelligence_pset_notes.md)
